		...
		children: [
			{
				...
				name: "product",
				component: () =>
					import(/* webpackChunkName: "home" */ "@/views/product/index.vue")
			},
			{
				path: "/solution",
				name: "solution",
				...
				component: () =>
					import(/* webpackChunkName: "home1" */ "@/views/solution/index.vue"),
				children: [
					{
						path: "home1-1",
						name: "home1-1",
			...
			},
			{
				...
				name: "ecology",
				component: () =>
					import(/* webpackChunkName: "home" */ "@/views/ecology/index.vue")
			},
			{
				path: "/help",
				name: "help",
				component: () =>
					import(/* webpackChunkName: "home" */ "@/views/help/index.vue")
			},
			{
				path: "/about",
				name: "about",
			...
			},
			{
				...
				name: "foundation",
				component: () =>
					import(/* webpackChunkName: "home" */ "@/views/foundation/index.vue")
			}
		]
	}
];
